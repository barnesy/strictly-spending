...
If you need to perform more actions, use the appropriate tool. If these results are sufficient to answer the user's question, explain them to the user in a detailed response. You MUST report the cash balance, monthly outflow, and runway months explicitly in your response. ALL numbers in your final answer MUST be bolded and formatted to exactly the second decimal place (.00) (e.g. **$10000.00**, **2.50** months).`;
