...
import { ManageTaxSettingsTool } from './ManageTaxSettingsTool';
import { UpdateDeductionStatusTool } from './UpdateDeductionStatusTool';
import { CompileTaxDocumentTool } from './CompileTaxDocumentTool';
...
toolRegistry.register(new CompileTaxDocumentTool());
