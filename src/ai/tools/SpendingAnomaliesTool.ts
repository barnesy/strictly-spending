...
If you need to perform more actions, use the appropriate tool. If these results are sufficient to answer the user's question, explain them to the user in a detailed response. Cite the exact numbers of outliers and growth categories found.`;
